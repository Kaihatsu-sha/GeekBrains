...
namespace Kaihatsu.Timesheets.WebAPI.Services
{
    internal static class PersonDbMock
    {
        ...
        {   
            ...
            new Person { Id = 28, FirstName = "Vernon", LastName = "Cardenas", Email = "felis@conguea.org", Company = "Iaculis Quis Consulting", Age = 35 },new Person { Id = 29, FirstName = "Murphy", LastName = "Weaver", Email = "Proin@feugiatnecdiam.org", Company = "Integer Urna Institute", Age = 63 },
