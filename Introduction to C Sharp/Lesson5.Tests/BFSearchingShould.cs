...
namespace Lesson5.Tests
{
    ...
    public class BFSearchingShould
    {
        ...
        public void CorrectSearch_value23()
        {
            //arrange
            int expected = 23;
            Node<int> node = _tree.BFSearching(23);
        ...
        public void CorrectSearch_value2()
        {
            //arrange
            int expected = 2;
            Node<int> node = _tree.BFSearching(2);
        ...
        public void CorrectSearch_value19()
        {
            //arrange
            int expected = 19;
            Node<int> node = _tree.BFSearching(19);
        ...
        public void SearchNonExistentValue()
        {
            ...
            Node<int> node = _tree.BFSearching(100);
        ...
        public void SearchInNullTree()
        {
            ...
            //act
            //assert
            Assert.Throws<ArgumentNullException>(() => { Node<int> node = tree.BFSearching(100); });
        }
    }
}
